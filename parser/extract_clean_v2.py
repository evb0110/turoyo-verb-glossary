#!/usr/bin/env python3
"""
Clean Turoyo Parser V2
Uses tree-walking to properly handle text extraction without breaking words
"""
...
class CleanTuroyoParser:
    ...
    def has_turoyo_chars(self, text):
        ...
        turoyo_pattern = r'[ʕḥṣṭḏṯẓġǧəǝšč]'
    ...
    def parse_all(self):
        """Main parsing"""
        print("🔄 Parsing with tree-walking extraction...")
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            json.dump({
                ...
                'metadata': {
                    ...
                    'parser_version': '5.0.0-treewalk',
                    'notes': 'Tree-walking parser with proper word reconstruction'
                }
...
def main():
    ...
    parser.parse_all()
    parser.save_json('data/verbs_clean_v2.json')
